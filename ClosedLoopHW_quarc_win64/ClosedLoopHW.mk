...
## Generated on : Fri Dec 05 15:31:51 2025
...
COMPILER_COMMAND_FILE     = ClosedLoopHW_comp.rsp
CMD_FILE                  = ClosedLoopHW.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ClosedLoopHW.rt-win64
...
DEFINES_STANDARD = -DMODEL=ClosedLoopHW -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW.c $(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW_data.c $(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW_main.c $(START_DIR)\ClosedLoopHW_quarc_win64\rtGetInf.c $(START_DIR)\ClosedLoopHW_quarc_win64\rtGetNaN.c $(START_DIR)\ClosedLoopHW_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = ClosedLoopHW.obj ClosedLoopHW_data.obj ClosedLoopHW_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\ClosedLoopHW_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ClosedLoopHW_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ClosedLoopHW.obj : "$(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW.c"


ClosedLoopHW_data.obj : "$(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW_data.c"


ClosedLoopHW_main.obj : "$(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopHW_quarc_win64\ClosedLoopHW_main.c"


rtGetInf.obj : "$(START_DIR)\ClosedLoopHW_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopHW_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\ClosedLoopHW_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopHW_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\ClosedLoopHW_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopHW_quarc_win64\rt_nonfinite.c"
