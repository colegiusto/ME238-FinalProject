...
#ifndef RTW_HEADER_ClosedLoopHW_h_
#define RTW_HEADER_ClosedLoopHW_h_
#ifndef ClosedLoopHW_COMMON_INCLUDES_
#define ClosedLoopHW_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* ClosedLoopHW_COMMON_INCLUDES_ */
...
#define ClosedLoopHW_rtModel           RT_MODEL_ClosedLoopHW_T
...
#define rtB                            ClosedLoopHW_B
#define BlockIO                        B_ClosedLoopHW_T
#define rtP                            ClosedLoopHW_P
#define Parameters                     P_ClosedLoopHW_T
#define rtDWork                        ClosedLoopHW_DW
#define D_Work                         DW_ClosedLoopHW_T
...
extern P_ClosedLoopHW_T ClosedLoopHW_P;

/* Block signals (default storage) */
extern B_ClosedLoopHW_T ClosedLoopHW_B;

/* Block states (default storage) */
extern DW_ClosedLoopHW_T ClosedLoopHW_DW;

/* Model entry point functions */
extern void ClosedLoopHW_initialize(void);
extern void ClosedLoopHW_output(void);
extern void ClosedLoopHW_update(void);
extern void ClosedLoopHW_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ClosedLoopHW_rtModel *ClosedLoopHW(void);
...
extern RT_MODEL_ClosedLoopHW_T *const ClosedLoopHW_M;
 ...
 * '<S13>'  : 'ClosedLoopHW/Low-Pass Filter (Discrete or Continuous)/Initialization/Init_u'
 * '<S14>'  : 'ClosedLoopHW/Low-Pass Filter (Discrete or Continuous)/Integrator (Discrete or Continuous)/Discrete'
 * '<S15>'  : 'ClosedLoopHW/Subsystem/MATLAB Function'
 */
