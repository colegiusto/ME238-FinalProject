    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_P.DiscreteDerivative_ICPrevScaled
                    ...
                    ;% ClosedLoopHW_P.LowPassFilterDiscreteorContin_k
            ...
            section.data(41)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_P.Lykyhatkk1_Y0
                    section.data(1).logicalSrcIdx = 8;
                    section.data(1).dtTransOffset = 0;

                    ;% ClosedLoopHW_P.deltax_Y0
                    ...
                    ;% ClosedLoopHW_P.KalmanGainM_Value
                    section.data(19).logicalSrcIdx = 26;
                    section.data(19).dtTransOffset = 18;

                    ;% ClosedLoopHW_P.C_Value
                    ...
                    ;% ClosedLoopHW_P.Integrator_gainval
                    section.data(25).logicalSrcIdx = 32;
                    section.data(25).dtTransOffset = 54;

                    ;% ClosedLoopHW_P.Integrator_UpperSat
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_P.isSqrtUsed_Value
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(14)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_B.Product2
                    section.data(13).logicalSrcIdx = 13;
                    section.data(13).dtTransOffset = 23;

                    ;% ClosedLoopHW_B.Product3
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_DW.MemoryX_DSTATE
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 4;
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_DW.Integrator_PrevResetState
                    section.data(1).logicalSrcIdx = 24;
                    section.data(1).dtTransOffset = 0;

                    ;% ClosedLoopHW_DW.EnabledSubsystem_SubsysRanBC
                    section.data(2).logicalSrcIdx = 25;
                    section.data(2).dtTransOffset = 1;

                    ;% ClosedLoopHW_DW.MeasurementUpdate_SubsysRanBC
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_DW.Integrator_IC_LOADING
                    ...
                    ;% ClosedLoopHW_DW.is_active_c7_ctrlSharedLib
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% ClosedLoopHW_DW.doneDoubleBufferReInit_e
                    section.data(3).logicalSrcIdx = 32;
                    section.data(3).dtTransOffset = 2;

                    ;% ClosedLoopHW_DW.EnabledSubsystem_MODE
                    section.data(4).logicalSrcIdx = 33;
                    section.data(4).dtTransOffset = 3;

                    ;% ClosedLoopHW_DW.MeasurementUpdate_MODE
    ...
    targMap.checksum0 = 4082777471;
    targMap.checksum1 = 1301918820;
    targMap.checksum2 = 2612282779;
    targMap.checksum3 = 2531045437;
