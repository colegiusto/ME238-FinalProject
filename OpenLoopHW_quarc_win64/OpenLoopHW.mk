...
## Generated on : Tue Dec 09 11:18:42 2025
...
COMPILER_COMMAND_FILE     = OpenLoopHW_comp.rsp
CMD_FILE                  = OpenLoopHW.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\OpenLoopHW.rt-win64
...
DEFINES_STANDARD = -DMODEL=OpenLoopHW -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW.c $(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW_data.c $(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW_main.c $(START_DIR)\OpenLoopHW_quarc_win64\rtGetInf.c $(START_DIR)\OpenLoopHW_quarc_win64\rtGetNaN.c $(START_DIR)\OpenLoopHW_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = OpenLoopHW.obj OpenLoopHW_data.obj OpenLoopHW_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\OpenLoopHW_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\OpenLoopHW_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
OpenLoopHW.obj : "$(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW.c"


OpenLoopHW_data.obj : "$(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW_data.c"


OpenLoopHW_main.obj : "$(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopHW_quarc_win64\OpenLoopHW_main.c"


rtGetInf.obj : "$(START_DIR)\OpenLoopHW_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopHW_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\OpenLoopHW_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopHW_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\OpenLoopHW_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopHW_quarc_win64\rt_nonfinite.c"
