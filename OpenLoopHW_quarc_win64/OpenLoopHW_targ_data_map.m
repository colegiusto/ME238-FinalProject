    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(22)  = dumData; %prealloc
                    ...
                    section.data(5).dtTransOffset = 205;

                    ;% OpenLoopHW_P.HILInitialize_OOStart
                    section.data(6).logicalSrcIdx = 6;
                    section.data(6).dtTransOffset = 206;

                    ;% OpenLoopHW_P.HILInitialize_OOEnter
                    section.data(7).logicalSrcIdx = 7;
                    section.data(7).dtTransOffset = 207;

                    ;% OpenLoopHW_P.HILInitialize_AOFinal
                    section.data(8).logicalSrcIdx = 8;
                    section.data(8).dtTransOffset = 208;

                    ;% OpenLoopHW_P.HILInitialize_POFinal
                    section.data(9).logicalSrcIdx = 9;
                    section.data(9).dtTransOffset = 209;
                    ...
                    section.data(12).dtTransOffset = 212;
                    ...
                    section.data(16).dtTransOffset = 216;

                    ;% OpenLoopHW_P.HILInitialize_POFrequency
                    section.data(17).logicalSrcIdx = 17;
                    section.data(17).dtTransOffset = 217;

                    ;% OpenLoopHW_P.HILInitialize_POInitial
                    section.data(18).logicalSrcIdx = 18;
                    section.data(18).dtTransOffset = 218;
                    ...
                    section.data(21).dtTransOffset = 221;
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% OpenLoopHW_P.HILInitialize_CKChannels
                    ...
                    ;% OpenLoopHW_P.HILInitialize_DOWatchdog
                    ...
                    ;% OpenLoopHW_P.HILInitialize_POModes
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% OpenLoopHW_P.HILInitialize_AIChannels
                    section.data(1).logicalSrcIdx = 28;
                    section.data(1).dtTransOffset = 0;

                    ;% OpenLoopHW_P.HILInitialize_AOChannels
                    section.data(2).logicalSrcIdx = 29;
                    section.data(2).dtTransOffset = 4;

                    ;% OpenLoopHW_P.HILInitialize_EIChannels
            ...
            section.data(35)  = dumData; %prealloc
                    ...
                    ;% OpenLoopHW_P.HILInitialize_Active
                    section.data(1).logicalSrcIdx = 32;
                    section.data(1).dtTransOffset = 0;

                    ;% OpenLoopHW_P.HILInitialize_AOTerminate
                    section.data(2).logicalSrcIdx = 33;
                    section.data(2).dtTransOffset = 1;

                    ;% OpenLoopHW_P.HILInitialize_AOExit
                    section.data(3).logicalSrcIdx = 34;
                    section.data(3).dtTransOffset = 2;

                    ;% OpenLoopHW_P.HILInitialize_DOTerminate
                    section.data(4).logicalSrcIdx = 35;
                    section.data(4).dtTransOffset = 3;

                    ;% OpenLoopHW_P.HILInitialize_DOExit
                    section.data(5).logicalSrcIdx = 36;
                    section.data(5).dtTransOffset = 4;

                    ;% OpenLoopHW_P.HILInitialize_POTerminate
                    section.data(6).logicalSrcIdx = 37;
                    section.data(6).dtTransOffset = 5;

                    ;% OpenLoopHW_P.HILInitialize_POExit
                    section.data(7).logicalSrcIdx = 38;
                    section.data(7).dtTransOffset = 6;

                    ;% OpenLoopHW_P.HILInitialize_CKPStart
                    section.data(8).logicalSrcIdx = 39;
                    section.data(8).dtTransOffset = 7;

                    ;% OpenLoopHW_P.HILInitialize_CKPEnter
                    section.data(9).logicalSrcIdx = 40;
                    section.data(9).dtTransOffset = 8;

                    ;% OpenLoopHW_P.HILInitialize_CKStart
                    section.data(10).logicalSrcIdx = 41;
                    section.data(10).dtTransOffset = 9;

                    ;% OpenLoopHW_P.HILInitialize_CKEnter
                    section.data(11).logicalSrcIdx = 42;
                    section.data(11).dtTransOffset = 10;

                    ;% OpenLoopHW_P.HILInitialize_AIPStart
                    section.data(12).logicalSrcIdx = 43;
                    section.data(12).dtTransOffset = 11;

                    ;% OpenLoopHW_P.HILInitialize_AIPEnter
                    section.data(13).logicalSrcIdx = 44;
                    section.data(13).dtTransOffset = 12;

                    ;% OpenLoopHW_P.HILInitialize_AOPStart
                    section.data(14).logicalSrcIdx = 45;
                    section.data(14).dtTransOffset = 13;

                    ;% OpenLoopHW_P.HILInitialize_AOPEnter
                    section.data(15).logicalSrcIdx = 46;
                    section.data(15).dtTransOffset = 14;

                    ;% OpenLoopHW_P.HILInitialize_AOStart
                    section.data(16).logicalSrcIdx = 47;
                    section.data(16).dtTransOffset = 15;

                    ;% OpenLoopHW_P.HILInitialize_AOEnter
                    section.data(17).logicalSrcIdx = 48;
                    section.data(17).dtTransOffset = 16;

                    ;% OpenLoopHW_P.HILInitialize_AOReset
                    section.data(18).logicalSrcIdx = 49;
                    section.data(18).dtTransOffset = 17;

                    ;% OpenLoopHW_P.HILInitialize_DOPStart
                    section.data(19).logicalSrcIdx = 50;
                    section.data(19).dtTransOffset = 18;

                    ;% OpenLoopHW_P.HILInitialize_DOPEnter
                    section.data(20).logicalSrcIdx = 51;
                    section.data(20).dtTransOffset = 19;

                    ;% OpenLoopHW_P.HILInitialize_DOStart
                    section.data(21).logicalSrcIdx = 52;
                    section.data(21).dtTransOffset = 20;

                    ;% OpenLoopHW_P.HILInitialize_DOEnter
                    section.data(22).logicalSrcIdx = 53;
                    section.data(22).dtTransOffset = 21;

                    ;% OpenLoopHW_P.HILInitialize_DOReset
                    section.data(23).logicalSrcIdx = 54;
                    section.data(23).dtTransOffset = 22;

                    ;% OpenLoopHW_P.HILInitialize_EIPStart
                    section.data(24).logicalSrcIdx = 55;
                    section.data(24).dtTransOffset = 23;

                    ;% OpenLoopHW_P.HILInitialize_EIPEnter
                    section.data(25).logicalSrcIdx = 56;
                    section.data(25).dtTransOffset = 24;

                    ;% OpenLoopHW_P.HILInitialize_EIStart
                    section.data(26).logicalSrcIdx = 57;
                    section.data(26).dtTransOffset = 25;

                    ;% OpenLoopHW_P.HILInitialize_EIEnter
                    section.data(27).logicalSrcIdx = 58;
                    section.data(27).dtTransOffset = 26;

                    ;% OpenLoopHW_P.HILInitialize_POPStart
                    section.data(28).logicalSrcIdx = 59;
                    section.data(28).dtTransOffset = 27;

                    ;% OpenLoopHW_P.HILInitialize_POPEnter
                    section.data(29).logicalSrcIdx = 60;
                    section.data(29).dtTransOffset = 28;

                    ;% OpenLoopHW_P.HILInitialize_POStart
                    section.data(30).logicalSrcIdx = 61;
                    section.data(30).dtTransOffset = 29;

                    ;% OpenLoopHW_P.HILInitialize_POEnter
                    section.data(31).logicalSrcIdx = 62;
                    section.data(31).dtTransOffset = 30;

                    ;% OpenLoopHW_P.HILInitialize_POReset
                    section.data(32).logicalSrcIdx = 63;
                    section.data(32).dtTransOffset = 31;

                    ;% OpenLoopHW_P.HILInitialize_OOReset
                    section.data(33).logicalSrcIdx = 64;
                    section.data(33).dtTransOffset = 32;

                    ;% OpenLoopHW_P.HILInitialize_DOFinal
                    section.data(34).logicalSrcIdx = 65;
                    section.data(34).dtTransOffset = 33;

                    ;% OpenLoopHW_P.HILInitialize_DOInitial
    ...
    targMap.checksum0 = 3560354192;
    targMap.checksum1 = 184879751;
    targMap.checksum2 = 3896669209;
    targMap.checksum3 = 3543781902;
