###########################################################################
## Makefile generated for component 'Lab1'. 
## 
## Makefile     : Lab1.mk
## Generated on : Wed Dec 03 11:01:36 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Lab1.rt-win64
...
COMPILER_COMMAND_FILE     = Lab1_comp.rsp
CMD_FILE                  = Lab1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Lab1.rt-win64
...
DEFINES_STANDARD = -DMODEL=Lab1 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Lab1_quarc_win64\Lab1.c $(START_DIR)\Lab1_quarc_win64\Lab1_data.c $(START_DIR)\Lab1_quarc_win64\Lab1_main.c $(START_DIR)\Lab1_quarc_win64\rtGetInf.c $(START_DIR)\Lab1_quarc_win64\rtGetNaN.c $(START_DIR)\Lab1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Lab1.obj Lab1_data.obj Lab1_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Lab1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Lab1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Lab1.obj : "$(START_DIR)\Lab1_quarc_win64\Lab1.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab1_quarc_win64\Lab1.c"


Lab1_data.obj : "$(START_DIR)\Lab1_quarc_win64\Lab1_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab1_quarc_win64\Lab1_data.c"


Lab1_main.obj : "$(START_DIR)\Lab1_quarc_win64\Lab1_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab1_quarc_win64\Lab1_main.c"


rtGetInf.obj : "$(START_DIR)\Lab1_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab1_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Lab1_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab1_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Lab1_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab1_quarc_win64\rt_nonfinite.c"
